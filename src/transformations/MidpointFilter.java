 ...
 * @date 05/20/2018
 */
public class MidpointFilter implements TransformationAlgorithm {
	
	/**
	 * Creates an object for midpoint filter
	 * @param m the Model for MVC.
	 */
	public MidpointFilter(Model m) {
